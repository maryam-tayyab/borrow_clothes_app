...
* Recall that controllers are used by views (Activities/Fragments) to interact with the model. 
* In MVC views do not make direct contact with the model, instead controllers act as the buffer between them. 
*/
